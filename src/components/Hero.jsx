...
const Hero = () => {
  ...
  const handleClick = () => {
    ...
    navigate('/iconedit'); // Make sure the route '/iconedit' exists in your router
  };
  ...
  return (
    <div>
      ...
      >
        ...
        <motion.button
          className="bg-gradient-to-r from-blue-500 to-purple-500 text-white px-8 py-4 rounded-full text-xl font-semibold transition-all duration-300 hover:from-blue-600 hover:to-purple-600 hover:shadow-lg relative z-10"
          onClick={handleClick} // Correct event handler
          whileTap={{ scale: 0.95 }}
        >
          Get Started
        </motion.button>
